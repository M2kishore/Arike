# Generated by Django 4.0.1 on 2022-03-13 14:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expired_time', models.DateTimeField(default=datetime.datetime(2022, 3, 13, 14, 6, 5, 59577, tzinfo=utc), null=True)),
            ],
        ),
        migrations.CreateModel(
            name='State',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateTimeField(default=datetime.datetime(2022, 3, 13, 14, 6, 5, 61238, tzinfo=utc))),
